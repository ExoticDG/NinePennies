...
pub fn first_queries() -> (String, String, String, String, String) {
    ...
    let _ = stdout().flush(); 
    stdin().read_line(&mut total_length).expect("Failed to read line");
    ...
    return (total_length, first_character, second_character, third_character, fourth_character);
}